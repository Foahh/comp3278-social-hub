...
function Skeleton({ children, ...props }: BitSkeletonProp) {
  ...
  return (
    <div className={cn("relative animate-pulse", className)}>
      ...
      <div className="absolute top-0 left-0 size-0.5 bg-foreground/60 dark:bg-ring/60" />
      <div className="absolute top-0 right-0 size-0.5 bg-foreground/60 dark:bg-ring/60" />
      <div className="absolute bottom-0 left-0 size-0.5 bg-foreground/60 dark:bg-ring/60" />
      <div className="absolute right-0 bottom-0 size-0.5 bg-foreground/60 dark:bg-ring/60" />
      <div className="opacity-60">
