...
async def test_register_success(client):
    with (
        ...
        mock_q.get_user_by_id = AsyncMock(return_value={
            "user_id": 1, "username": "alice", "email": "alice@test.com", "avatar_key": None
        })
...
async def test_login_success(client):
    ...
    with (
        ...
        mock_q.get_user_by_email = AsyncMock(return_value={
            "user_id": 1, "username": "alice", "email": "alice@test.com",
            "password_hash": hashed, "avatar_key": None,
        })
